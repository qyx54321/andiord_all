...
import com.example.zy07.bean.UserInfo;
import com.example.zy07.datebase.UserDBHelper;
import com.example.zy07.util.DateUtil;
import com.example.zy07.util.ViewUtil;
import com.example.zy07.R;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, View.OnFocusChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ck_remember = findViewById(R.id.sw_status);
    ...
    private String[] typeArray = {"个人用户", "公司用户","18990041戚有学"};
